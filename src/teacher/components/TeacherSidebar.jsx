    ...
    <div className="flex h-full flex-col">
      ...
      >
        {!collapsed && (
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-7 h-7 bg-[#2C2DE0] dark:bg-[#1E1FAA] rounded-lg flex items-center justify-center shrink-0">
        ...
        {collapsed && (
          <div className="w-7 h-7 bg-[#2C2DE0] dark:bg-[#1E1FAA] rounded-lg flex items-center justify-center">
            <GraduationCap size={14} className="text-white" />
          </div>
        )}
        <button
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-5">
        {TEACHER_SIDEBAR_SECTIONS.map((section) => (
          <div key={section.id}>
            {!collapsed && (
              <p className="mb-1.5 px-3 text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 dark:text-gray-400">
      ...
      >
        <div className="w-8 h-8 bg-[#2C2DE0] dark:bg-[#1E1FAA] rounded-full flex items-center justify-center text-white text-xs font-bold shrink-0">
        ...
        {!collapsed && (
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 mt-0.5">
              <div className="w-1.5 h-1.5 bg-[#2C2DE0] dark:bg-[#1E1FAA] rounded-full" />
              <p className="text-[11px] text-[#1E1FAA] dark:text-[#4F51FF]">{t.common.online}</p>
            </div>
          </div>
        )}
      </div>
