                    ...
                    <button className="bg-[#2C2DE0] text-white text-sm font-bold shadow-[0_4px_0_#1E1FAA] hover:translate-y-0.5 hover:shadow-[0_2px_0_#1E1FAA] active:translate-y-1 active:shadow-none transition-all duration-150 group"
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-semibold border transition-colors ${
                        types.includes(opt.id)
                          ? "bg-[#2C2DE0] border-[#4F51FF] text-[#0F0F55] dark:text-blue-300 dark:bg-[#2C2DE0]/40 dark:text-[#2C2DE0]"
          ...
          {preview && (
            <>
              <div className="flex items-center justify-between">
                ...
                <button className="bg-[#2C2DE0] text-white text-sm font-bold shadow-[0_4px_0_#1E1FAA] hover:translate-y-0.5 hover:shadow-[0_2px_0_#1E1FAA] active:translate-y-1 active:shadow-none transition-all duration-150 group" onClick={() => setPreview(null)} className="text-xs font-semibold text-gray-500 hover:text-gray-700 dark:text-gray-300">
                  ↺ Start over
                </button>
              </div>
              ...
              <div className="space-y-2 max-h-80 overflow-y-auto pr-1">
                {preview.map((q, idx) => (
                  <div key={idx} className="flex items-start gap-3 p-3 rounded-xl border border-gray-100 dark:border-zinc-800">
                    ...
                    <button className="bg-[#2C2DE0] text-white text-sm font-bold shadow-[0_4px_0_#1E1FAA] hover:translate-y-0.5 hover:shadow-[0_2px_0_#1E1FAA] active:translate-y-1 active:shadow-none transition-all duration-150 group" onClick={() => removePreviewItem(idx)} className="text-red-400 hover:text-red-600 p-1 shrink-0">
