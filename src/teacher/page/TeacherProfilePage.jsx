      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <UserCircle className="text-[#2C2DE0] dark:text-[#4F51FF]" />
            {p.title || "Profile"}
          </h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{p.subtitle || "Update your personal information and account settings."}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea 
                  rows="4"
                  className="w-full p-3 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF] dark:text-white resize-none"
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="password" placeholder="••••••••" className="w-full px-4 py-2.5 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF] dark:text-white" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 p-6 shadow-sm flex flex-col items-center text-center">
            <div className="w-24 h-24 rounded-full bg-[#2C2DE0] dark:bg-[#2C2DE0] dark:bg-[#1E1FAA]/20 text-[#1E1FAA] dark:text-[#4F51FF] dark:text-[#4F51FF] flex items-center justify-center text-3xl font-bold mb-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">{form.department}</p>
            
            <div className="w-full h-px bg-gray-100 dark:bg-zinc-800 my-6"></div>
            
            <div className="w-full space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">{p.status || "Status"}</span>
                <span className="font-semibold text-[#1E1FAA] dark:text-[#4F51FF] dark:text-[#4F51FF]">{p.active || "Active"}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">{p.memberSince || "Member Since"}</span>
