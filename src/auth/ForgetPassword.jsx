...
function calcStrength(score, t) {
  ...
  return { label: t("auth.passwordStrengthStrong"), bars: 4, bar: "bg-[#2C2DE0] dark:bg-[#1E1FAA]", text: "text-[#2C2DE0] dark:text-[#4F51FF]" };
}
        ...
        {checks.map((c) => (
          <div
            ...
            className={`flex items-center gap-1.5 text-[11px] transition-colors duration-200 ${
              c.met
                ? "text-[#1E1FAA] dark:text-[#4F51FF] dark:text-[#4F51FF]"
...
const LogoMark = ({ size = 9 }) => (
  <div className={`w-${size} h-${size} rounded-xl bg-[#2C2DE0] dark:bg-[#1E1FAA] flex items-center justify-center shadow-sm shadow-[#2C2DE0]`}>
...
const StepPill = ({ n, active, done }) => (
  <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all shrink-0 ${
      ...
      : active
        ? "bg-[#2C2DE0] dark:bg-[#1E1FAA] text-white ring-4 ring-[#2C2DE0] dark:ring-[#4F51FF]/20"
            ...
            <div className="flex flex-col items-center text-center py-12 anim-fadeup">
              <div className="relative w-16 h-16 mb-6">
                ...
                {step === "sending" ? (
                  ...
                  <ShieldCheck size={22} className="absolute inset-0 m-auto text-[#2C2DE0] dark:text-[#4F51FF]" />
                )}
              </div>
  ...
  <ArrowRight size={15} className="group-hover:translate-x-0.5 transition-transform" />
          ...
          {step === "verify" && (
            <div className="anim-slidein">
              <div className="flex items-center gap-2 mb-6">
                <StepPill n={1} done />
                <div className="h-px flex-1 bg-[#4F51FF]" />
                <StepPill n={2} active />
              </div>
              ...
              {/* Locked email badge */}
              <div className="mt-4 mb-1 flex items-center gap-2.5 bg-[#2C2DE0]/5 dark:bg-[#4F51FF]/10 dark:bg-[#2C2DE0] dark:bg-[#1E1FAA]/10 border border-[#2C2DE0] dark:border-[#2C2DE0] dark:border-[#4F51FF]/30 rounded-xl px-4 py-2.5">
              ...
              <form onSubmit={handleReset} className="mt-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    maxLength={6}
                    autoFocus
                    className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm font-mono font-bold tracking-[0.3em] text-center text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2C2DE0]/30 focus:border-[#4F51FF] transition-all uppercase"
                  />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 pl-10 pr-11 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2C2DE0]/30 focus:border-[#4F51FF] transition-all"
                    />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 pl-10 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2C2DE0]/30 focus:border-[#4F51FF] transition-all"
                    />
                  </div>
...
{/* Resend — secondary action, so it's a plain text link, not a duplicate CTA */}
<div className="mt-5 text-center">
  ...
  <button
    ...
    className="text-sm font-semibold text-[#2C2DE0] dark:text-[#4F51FF] hover:underline"
  >
    {t("auth.forgotResendCode")}
              ...
              <button 
                ...
                className="w-full mt-4 text-center text-xs text-gray-400 hover:text-[#1E1FAA] dark:text-[#4F51FF] dark:hover:text-[#4F51FF] font-semibold transition-colors"
              >
      ...
      <div className="hidden md:flex w-1/2 bg-black dark:bg-gray-950 flex-col justify-center items-center px-14 text-center relative overflow-hidden">
        ...
        {/* Decorative rings */}
        <div className="absolute w-120 h-120 rounded-full border border-[#2C2DE0] dark:border-[#4F51FF]/10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
        <div className="absolute w-85 h-85 rounded-full border border-[#2C2DE0] dark:border-[#4F51FF]/10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
        ...
        <div className="relative z-10 max-w-sm">
          ...
          <div className="mt-8 bg-[#2C2DE0] dark:bg-[#1E1FAA]/10 border border-[#2C2DE0] dark:border-[#4F51FF]/20 rounded-2xl px-5 py-4 text-left">
            <p className="text-[11px] font-bold uppercase tracking-widest text-[#4F51FF] mb-1">
