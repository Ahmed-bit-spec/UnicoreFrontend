            ...
            <div className="anim-slidein">
              ...
              <form onSubmit={handleVerifySubmit} className="mt-5 flex flex-col gap-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2  hover:bg-[#2C2DE0] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm py-3 rounded-xl  bg-[#58CC02] text-white text-sm font-bold
