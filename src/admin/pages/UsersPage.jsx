  ...
  const columns = [
    {
      ...
      label: p.avatar,
      render: (row) => (
        <div className="flex size-9 items-center justify-center overflow-hidden rounded-full bg-[#2C2DE0] dark:bg-[#1E1FAA]/10 text-xs font-bold text-[#0F0F55] dark:text-blue-300 ring-1 ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:text-[#4F51FF]">
          {row.avatar ? (
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="space-y-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">
            {p.fullName}
            <input className="w-full rounded-xl border border-gray-200/80 bg-white/80 px-3 py-2 text-sm text-gray-900 outline-none focus:border-[#2C2DE0] dark:border-[#4F51FF]/40 focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:border-white/10 dark:bg-white/5 dark:text-white" value={form.fullName} onChange={(event) => setForm((current) => ({ ...current, fullName: event.target.value }))} />
            {formErrors.fullName && <span className="text-[11px] font-semibold text-red-500">{formErrors.fullName}</span>}
          </label>
          <label className="space-y-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">
            {p.email}
            <input className="w-full rounded-xl border border-gray-200/80 bg-white/80 px-3 py-2 text-sm text-gray-900 outline-none focus:border-[#2C2DE0] dark:border-[#4F51FF]/40 focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:border-white/10 dark:bg-white/5 dark:text-white" value={form.email} onChange={(event) => setForm((current) => ({ ...current, email: event.target.value }))} />
            {formErrors.email && <span className="text-[11px] font-semibold text-red-500">{formErrors.email}</span>}
          </label>
          <label className="space-y-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">
            {p.studentId}
            <input className="w-full rounded-xl border border-gray-200/80 bg-white/80 px-3 py-2 text-sm text-gray-900 outline-none focus:border-[#2C2DE0] dark:border-[#4F51FF]/40 focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:border-white/10 dark:bg-white/5 dark:text-white" value={form.studentId} onChange={(event) => setForm((current) => ({ ...current, studentId: event.target.value }))} />
          </label>
          <label className="space-y-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200/80 bg-white/80 px-3 py-2 text-sm text-gray-900 outline-none focus:border-[#2C2DE0] dark:border-[#4F51FF]/40 focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:border-white/10 dark:bg-white/5 dark:text-white"
              value={form.password}
          ...
          <label className="space-y-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">
            {p.role}
            <select className="w-full rounded-xl border border-gray-200/80 bg-white/80 px-3 py-2 text-sm text-gray-900 outline-none focus:border-[#2C2DE0] dark:border-[#4F51FF]/40 focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:border-white/10 dark:bg-gray-950 dark:text-white" value={form.role} onChange={(event) => setForm((current) => ({ ...current, role: event.target.value }))}>
          ...
          <label className="space-y-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300">
            {p.accountStatus}
            <select className="w-full rounded-xl border border-gray-200/80 bg-white/80 px-3 py-2 text-sm text-gray-900 outline-none focus:border-[#2C2DE0] dark:border-[#4F51FF]/40 focus:ring-2 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/20 dark:border-white/10 dark:bg-gray-950 dark:text-white" value={form.accountStatus} onChange={(event) => setForm((current) => ({ ...current, accountStatus: event.target.value }))}>
          ...
          <div className="grid gap-3 rounded-xl border border-gray-200/70 bg-white/50 p-3 dark:border-white/10 dark:bg-white dark:bg-gray-900/[0.03]">
            <label className="flex items-center justify-between gap-3 text-xs font-semibold text-gray-600 dark:text-gray-300">
              {p.emailVerification}
              <input type="checkbox" checked={form.emailVerified} onChange={(event) => setForm((current) => ({ ...current, emailVerified: event.target.checked }))} className="rounded border-gray-300 text-[#2C2DE0] dark:text-[#4F51FF] focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/30" />
            </label>
            <label className="flex items-center justify-between gap-3 text-xs font-semibold text-gray-600 dark:text-gray-300">
              {p.universityVerification}
              <input type="checkbox" checked={form.universityVerified} onChange={(event) => setForm((current) => ({ ...current, universityVerified: event.target.checked }))} className="rounded border-gray-300 text-[#2C2DE0] dark:text-[#4F51FF] focus:ring-[#2C2DE0] dark:ring-[#4F51FF]/30" />
            </label>
          </div>
        </div>
      </Modal>
