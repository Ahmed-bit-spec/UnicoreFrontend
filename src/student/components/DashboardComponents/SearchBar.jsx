...
const SearchBar = ({ value = "", onChange = () => { }, onClear = () => { }, variant = "default", placeholder = "Search..." }) => {
    const baseClass = `w-full pl-3 pr-3 py-2 rounded-xl text-sm bg-[#1A1A1A] border border-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-green-500/40`;
    return (
