  ...
  return (
    <div className="relative flex gap-5">
      <div className="flex flex-col items-center flex-shrink-0">
        <div className="w-10 h-10 rounded-2xl bg-[#2C2DE0] dark:bg-[#1E1FAA] flex items-center justify-center shadow-sm shadow-[#2C2DE0] dark:shadow-none flex-shrink-0">
      ...
      <div className="flex-1 pb-8">
        ...
        >
          <div className="flex-1 min-w-0">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#2C2DE0] dark:text-[#4F51FF] block mb-1">
              Step {step.number}
            </span>
        ...
        {open && (
          <div className="mt-3 flex flex-col gap-3">
            ...
            <div className="flex items-start gap-2.5 bg-[#2C2DE0]/5 dark:bg-[#4F51FF]/10 dark:bg-[#2C2DE0] dark:bg-[#1E1FAA]/10 border border-[#2C2DE0] dark:border-[#2C2DE0] dark:border-[#4F51FF]/20 rounded-xl px-3.5 py-3">
              <CheckCircle2 size={13} className="text-[#2C2DE0] dark:text-[#4F51FF] flex-shrink-0 mt-0.5" />
              <p className="text-xs text-[#0F0F55] dark:text-blue-300 dark:text-[#4F51FF] leading-relaxed">
    ...
    <section className="max-w-6xl mx-auto mt-10 px-6">
      <div className="grid md:grid-cols-2 gap-6 items-start">
        <div className="md:sticky md:top-24">
          ...
          <a
            href="/seats"
            className="mt-8 inline-flex items-center gap-2 bg-[#2C2DE0] dark:bg-[#1E1FAA] hover:bg-[#1E1FAA] dark:bg-[#0F0F55] active:bg-[#2C2DE0] text-white font-bold px-5 py-3 rounded-xl transition-all shadow-sm shadow-[#2C2DE0] dark:shadow-none group text-sm"
          >
