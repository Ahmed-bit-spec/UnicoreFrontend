    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      {STAT_CONFIG.map(({ key, icon: Icon, label, href, tint, bg }) => (
        <Link
          key={key}
          to={href}
          className="group bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-2xl px-4 py-4 flex items-center gap-3.5 hover:border-[#4F51FF] dark:border-blue-400 dark:hover:border-[#2C2DE0] hover:-translate-y-0.5 transition-all duration-150"
        >
          <div
