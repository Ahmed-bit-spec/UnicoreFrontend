          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {(r.extensionCount ?? 0) >= 1 && (
                <span className="bg-white/20 text-white text-[10px] font-bold px-2 py-0.5 rounded-lg">
                  {copy.extendedBadge ?? "Extended"}
                </span>
              )}
              <span className="bg-white/20 text-white text-xs font-mono font-bold px-2.5 py-1 rounded-lg">#{shortId}</span>
