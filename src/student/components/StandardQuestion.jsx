        ...
        {question.options?.map((opt, i) => (
          <label
            ...
            className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all
              ${value === opt
                ? "border-[#2C2DE0] dark:border-[#4F51FF] bg-[#2C2DE0]/5 dark:bg-[#4F51FF]/10 dark:border-[#2C2DE0] dark:border-[#4F51FF] dark:bg-[#2C2DE0]/20"
          ...
          >
            <input
              ...
              className="w-5 h-5 text-[#1E1FAA] dark:text-[#4F51FF] border-neutral-300 focus:ring-[#2C2DE0] dark:ring-[#4F51FF]"
            />
  ...
  if (question.type === "essay") {
    return (
      <div className="space-y-2">
        <textarea
          className="w-full h-64 border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 rounded-xl p-4 focus:ring-[#2C2DE0] dark:ring-[#4F51FF] focus:border-[#2C2DE0] dark:border-[#4F51FF] resize-none"
